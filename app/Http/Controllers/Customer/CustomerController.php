...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = \App\Models\Category::all(); // Fix missing categories
    ...
    public function show(Product $product)
    {
        ...
        $related = Product::where('category_id', $product->category_id)
            ...
            ->get();
        $cartCount = $this->getCartCount();
        return view('customer.product', compact('product', 'related', 'cartCount'));
    }
    ...
    public function cart()
    {
        ...
        return view('customer.cart', compact('cartItems', 'cartTotal', 'cartCount'));
    }
    ...
    public function checkout()
    {
        ...
        return view('customer.checkout', compact('cartItems', 'subtotal', 'tax', 'total'));
    }
    ...
    public function processCheckout(Request $request)
    {
        ...
        try {
            ...
            $transaction = Transaction::create([
                ...
                'user_id' => auth()->id() ?? null, // Guest checkout
