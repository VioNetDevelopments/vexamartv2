            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-navy-900 rounded-2xl p-6 shadow-lg shadow-slate-200/50 dark:shadow-black/20 animate-fade-in-up"
                    ...
                    <div class="mt-6 space-y-3">
                        @php
                            $colorCodes = ['#2563EB', '#16A34A', '#F59E0B', '#8B5CF6', '#EC4899', '#06B6D4'];
                        @endphp
                        @forelse($paymentData['labels'] as $index => $label)
                            <div
                                class="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-navy-800 transition-all duration-300 hover:scale-[1.02]">
                                <div class="flex items-center gap-3">
                                    <div class="w-2.5 h-2.5 rounded-full shadow-sm"
                                        style="background-color: {{ $colorCodes[$index % count($colorCodes)] }}"></div>
                                    <span class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ $label }}</span>
                                </div>
                                <span
                                    class="text-sm font-bold text-navy-900 dark:text-white">{{ $paymentData['percentages'][$index] }}%</span>
                            </div>
                        @empty
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-navy-900 rounded-2xl p-6 shadow-lg shadow-slate-200/50 dark:shadow-black/20 animate-fade-in-up"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="prevProductPage()"
                                class="p-2 hover:bg-slate-100 dark:hover:bg-navy-800 rounded-lg transition-colors">
                                <i data-lucide="chevron-left" class="w-4 h-4 text-slate-500"></i>
                            </button>
                            <button onclick="nextProductPage()"
                                class="p-2 hover:bg-slate-100 dark:hover:bg-navy-800 rounded-lg transition-colors">
                    ...
                    <div class="space-y-4" id="productList">
                        @forelse($topProducts as $index => $product)
                            <div
                                class="group flex items-center gap-4 p-4 rounded-xl bg-slate-50 dark:bg-navy-800 hover:bg-accent-50 dark:hover:bg-navy-700 transition-all duration-300 hover:-translate-x-2 product-item">
                                <div
                ...
                <div class="bg-white dark:bg-navy-900 rounded-2xl p-6 shadow-lg shadow-slate-200/50 dark:shadow-black/20 animate-fade-in-up"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="prevTransactionPage()"
                                class="p-2 hover:bg-slate-100 dark:hover:bg-navy-800 rounded-lg transition-colors">
                                <i data-lucide="chevron-left" class="w-4 h-4 text-slate-500"></i>
                            </button>
                            <button onclick="nextTransactionPage()"
                                class="p-2 hover:bg-slate-100 dark:hover:bg-navy-800 rounded-lg transition-colors">
                                <i data-lucide="chevron-right" class="w-4 h-4 text-slate-500"></i>
                            </button>
                        </div>
                    ...
                    <div class="space-y-3" id="transactionList">
                        @forelse($recentTransactions as $transaction)
                            <div
                                class="group flex items-center gap-4 p-4 rounded-xl bg-slate-50 dark:bg-navy-800 hover:bg-slate-100 dark:hover:bg-navy-700 transition-all duration-300 transaction-item">
                                <div
