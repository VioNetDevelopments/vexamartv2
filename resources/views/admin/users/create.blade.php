        ...
        <div class="relative max-w-5xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4 animate-fade-in-down">
                ...
                <div>
                    ...
                    <p class="text-slate-600 dark:text-slate-400">Daftarkan pengguna baru ke sistem</p>
                </div>
            </div>

            <!-- Form -->
            <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" 
                @submit.prevent="notify.confirm('Mau daftarin user baru nih KING? Udah bener email sama role-nya?', () => $el.submit())"
                x-data="{ 
                      avatarPreview: null,
                      showPassword: false
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100 dark:border-white/10">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Data pribadi user baru</p>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100 dark:border-white/10">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400">Atur password akses</p>
                                </div>
                            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div class="space-y-4">
                                <!-- Role -->
                                <div x-data="{ roleOpen: false, roleVal: '{{ old('role') }}', roleText: '{{ old('role') ? (old('role') == 'owner' ? 'Owner' : (old('role') == 'admin' ? 'Admin' : (old('role') == 'cashier' ? 'Kasir' : 'Customer'))) : 'Pilih Role' }}' }">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-3" x-data="{ activeStatus: '{{ old('is_active', '1') }}' }">
        ...
        <script>
            function handleFileSelect(event) {
                ...
                if (file) {
                    ...
                    reader.onload = (e) => {
                        // Use document.querySelector to update the Alpine model or just the img src
                        // Since we are in Alpine context, we should ideally use the Alpine data, 
                        // but this is a simple preview.
                        const preview = document.querySelector('img[src]'); // Not quite right
                        // Better to let Alpine handle it.
                    };
                    
                    // Actually, let's just use the URL object for temporary preview
