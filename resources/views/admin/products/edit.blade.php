        ...
        <div class="relative max-w-5xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4 animate-fade-in-down">
                ...
                <div>
                    ...
                    <p class="text-slate-600 dark:text-slate-400">Update informasi produk</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" 
                  ...
                  x-data="{ 
                      ...
                      confirmUpdate() {
                          Swal.fire({
                              title: 'Fix nih mau update, King?',
                              text: 'Data produk ini mau kita permak sesuai kemauan lu, sikat gak, King?',
                              icon: 'question',
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-navy-900 rounded-2xl p-6 shadow-lg shadow-slate-200/50 dark:shadow-black/20">
                            ...
                            <div class="space-y-4">
                                ...
                                @if($product->image)
                                    <button type="button" @click="existingImage = ''; $refs.imageInput.value = ''"
                                            class="w-full rounded-xl border border-danger/20 text-danger py-2.5 text-sm font-medium hover:bg-danger/5 transition-colors">
                                        Hapus Gambar
                                    </button>
                                @endif
