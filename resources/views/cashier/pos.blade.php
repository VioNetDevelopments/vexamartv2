...
<div class="h-[calc(100vh-8rem)]" x-data="posApp()" x-init="init()">
    <div class="flex h-full gap-4">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <!-- Products Grid -->
            <div class="flex-1 overflow-y-auto rounded-2xl bg-white p-4 shadow-soft dark:bg-navy-900 dark:border dark:border-white/5">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <template x-for="product in products" :key="product.id">
                        <div @click="addToCart(product)"
                            ...
                            <h4 class="font-medium text-sm text-navy-900 dark:text-white line-clamp-2" x-text="product.name"></h4>
                            <p class="text-xs text-slate-500 mt-1" x-text="product.category?.name"></p>
                            <div class="flex items-center justify-between mt-2">
                                <span class="text-lg font-bold text-accent-500" x-text="formatRupiah(product.sell_price)"></span>
        ...
        <div class="w-96 flex flex-col overflow-hidden">
            <div class="rounded-2xl bg-white shadow-soft dark:bg-navy-900 dark:border dark:border-white/5 h-full flex flex-col">
                <!-- Cart Header -->
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-3">
                    <template x-for="(item, index) in cart" :key="item.product_id">
                        <div class="flex gap-3 p-3 rounded-xl bg-slate-50 dark:bg-navy-800">
                            <div class="h-16 w-16 rounded-lg bg-slate-200 dark:bg-navy-700 overflow-hidden flex-shrink-0">
                ...
                <div class="p-4 border-t border-slate-100 dark:border-white/5 space-y-3">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between text-lg font-bold text-navy-900 dark:text-white pt-2 border-t border-slate-100 dark:border-white/5">
                            <span>Total</span>
                    ...
                    <div x-show="paymentMethod === 'qris'" 
                        ...
                        <div class="text-center mb-3">
                            <p class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Scan QRIS untuk Bayar</p>
                            <p class="text-xs text-slate-500">Gunakan GoPay, OVO, DANA, ShopeePay, atau Mobile Banking</p>
                        </div>
                        ...
                        <div class="mt-3 flex items-center justify-center gap-2">
                            ...
                            <span class="text-xs text-slate-500" x-text="qrisLoading ? 'Menunggu pembayaran...' : 'QR Code siap'"></span>
                        </div>
        ...
        <div class="relative bg-white rounded-2xl p-8 max-w-lg w-full shadow-2xl dark:bg-navy-900 text-center"
            ...
            <div class="bg-white p-6 rounded-xl inline-block mb-6 shadow-lg">
                ...
                <div x-show="qrisLoading" class="w-64 h-64 flex items-center justify-center">
                    <div class="animate-spin rounded-full h-20 w-20 border-4 border-accent-500 border-t-transparent"></div>
                </div>
            </div>
            ...
            <div class="flex gap-3 justify-center">
                ...
                <button @click="cancelQrisPayment()" 
                        class="px-6 py-2 rounded-lg bg-danger text-white hover:bg-red-700">
    ...
    <div x-show="showSuccessModal" x-cloak
        ...
        <div class="relative bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl dark:bg-navy-900 text-center"
            ...
            <p class="text-slate-500 dark:text-slate-400 mb-4">Invoice: <span class="font-mono font-bold" x-text="lastInvoice"></span></p>
            <div class="flex gap-3 justify-center">
                <button @click="printReceipt()" class="px-4 py-2 rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50 dark:border-white/10 dark:text-slate-300">
                ...
                <button @click="newTransaction()" class="px-4 py-2 rounded-lg bg-accent-500 text-white hover:bg-accent-600">
                    Transaksi Baru
                </button>
            </div>
        </div>
