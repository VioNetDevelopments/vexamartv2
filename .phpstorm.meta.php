...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\vexamartv2\public\storage' => 'string',
...
'app.providers','app.aliases.Pdf','app.aliases.SnappyPdf','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\vexamartv2\\public\\storage',
...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','snappy.pdf.enabled',
'snappy.pdf.binary','snappy.pdf.timeout','snappy.pdf.options','snappy.pdf.env','snappy.image.enabled',
'snappy.image.binary','snappy.image.timeout','snappy.image.options','snappy.image.env','blade-heroicons.prefix',
'blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','blade-icons.sets','blade-icons.class',
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','sanctum.stateful',
...
'excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','tinker.commands','tinker.alias','tinker.dont_alias',
'tinker.trust_project',);
        registerArgumentsSet('middleware', 
'web','api','auth','auth.basic','auth.session',
'cache.headers','can','guest','password.confirm','precognitive',
'signed','throttle','verified','role','active',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','generated::h0cACzPhsaTNN6ft','generated::Gv23XmP9iHARGy4y','generated::1nPeM6Bl1AAVxH3q','login',
'generated::AJLTYcUxT2Geh96O','register','register.post','generated::OD0WdPRnnOJKcHAk','api.settings',
'api.settings.upload-logo','logout','admin.activity-logs','admin.dashboard','admin.search',
'admin.verification','admin.dashboard.chart-data','admin.dashboard.payment-data','admin.dashboard.top-products','admin.dashboard.recent-transactions',
'admin.products.index','admin.products.create','admin.products.store','admin.products.show','admin.products.edit',
'admin.products.update','admin.products.destroy','admin.products.toggle-status','admin.products.search','admin.products.by-barcode',
'admin.categories.index','admin.categories.store','admin.categories.update','admin.categories.destroy','admin.reports.index',
'admin.reports.export.excel','admin.reports.export.pdf','admin.stock.index','admin.stock.adjust','admin.stock.adjust.process',
'admin.stock.stock-in','admin.stock.stock-in.process','admin.stock.history','admin.stock.history.product','admin.stock.api.low-stock',
'admin.customers.index','admin.customers.create','admin.customers.store','admin.customers.show','admin.customers.edit',
'admin.customers.update','admin.customers.destroy','admin.customers.add-points','admin.customers.adjust-points','admin.users.index',
'admin.users.create','admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy',
'admin.users.toggle-status','admin.transactions.index','admin.transactions.show','admin.transactions.print','admin.settings.index',
'admin.settings.update','admin.settings.reset-logo','admin.settings.backup','cashier.pos','cashier.stock-check',
'cashier.product-stock','cashier.held-transactions.page','cashier.daily-sales.page','cashier.recent-transactions.page','cashier.daily-sales',
'cashier.stock-check.data','cashier.stock-stats','cashier.notifications','cashier.notifications.read','cashier.products.search',
'cashier.products.by-barcode','cashier.transaction.store','cashier.transaction.show','cashier.receipt.print','cashier.hold-transaction',
'cashier.held-transactions','cashier.recall-transaction','cashier.held-transaction.delete','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.activity-logs','admin.customers.edit','admin.customers.index','admin.customers.partials.table','admin.customers.show',
'admin.dashboard','admin.products.create','admin.products.edit','admin.products.index','admin.products.show',
'admin.reports.index','admin.settings.index','admin.stock.adjust','admin.stock.history','admin.stock.index',
'admin.stock.partials.table','admin.stock.stock-in','admin.transactions.index','admin.transactions.print','admin.transactions.show',
'admin.users.index','admin.users.partials.table','admin.verification','auth.login','auth.register',
'cashier.dashboard','cashier.pages.cash-management','cashier.pages.daily-sales','cashier.pages.held-transactions','cashier.pages.recent-transactions',
'cashier.pages.shift-history','cashier.pages.stock-check','cashier.pos','cashier.receipt','components.alert-modal',
'components.custom-alert','components.notification-bell','dashboard','layouts.app','layouts.sidebar',
...
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.vexamartv2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
